...
using System.Text;
using L2PacketDecrypt.Blowfish;

namespace L2PacketDecrypt.Crypt
{
    class NewCrypt
    {
        L2jBlowfishEngine _crypt;
        L2jBlowfishEngine _decrypt;
        ...
        public static void encXORPass(byte[] raw, int offset, int size, uint key)
        {
            int stop = size - 8;
            int pos = 4 + offset;
            int edx;
        ...
        public static int decXORPass(byte[] raw)
        {
            return decXORPass(raw, 2);
        }
        ...
        /// <returns>the orginal XOR-Key</returns>
        public static int decXORPass(byte[] raw, int offset)
        {
