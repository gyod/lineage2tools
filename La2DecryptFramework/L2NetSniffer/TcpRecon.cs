...
namespace L2NetSniffer
{
   ...
   of order packets in a smart way. */
    ...
    public class TcpRecon
    {
        ...
        public delegate void RstRecivedEventHandler(object sender);

        public event SynRecivedEventHandler OnSynRecived;
        public event FinRecivedEventHandler OnFinRecived;
        public event RstRecivedEventHandler OnRstRecived;
        ...
        public TcpRecon()
        {
            ...
            this.data_out[0] = new MemoryStream();
            this.data_out[1] = new MemoryStream();
        }

        public TcpRecon(Stream serverStream, Stream clientStream)
        {
            reset_tcp_reassembly();
            this.data_out[0] = clientStream;
            this.data_out[1] = serverStream;
        }
        ...
        private void write_packet_data(int index, byte[] data)
        {
            ...
            data_out[index].Write(data, 0, data.Length);
